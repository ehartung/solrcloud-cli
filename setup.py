...
EMAIL = 'enrico.hartung@zalando.de'
...
CONSOLE_SCRIPTS = ['solrcloud = solrcloud_cli.cli:main']
...
def setup_package():
    ...
    setup(
        ...
        url=URL,
        license=LICENSE,
        keywords='solr solrcloud deployment command line interface',
